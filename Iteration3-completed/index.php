...
//If session status is set and the twitter login information has been verified
//by the process page take user to the users home page, otherwise display login with twitter option.
	if(isset($_SESSION['status']) && $_SESSION['status'] == 'verified') 
	{
		...
		echo '<a href="process.php"><img src="images/pic2.png" width="588"  border="0" /></a>';
		echo '</div>';
		echo '</center>';
	}
?>  
